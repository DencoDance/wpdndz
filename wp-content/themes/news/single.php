            ...
            <div class="container">
                ...
                <div class="main-content <?php if($pagestyle == 'mpls2'){?>left-sidebar<?php }?>">
                    ...
                    <div class="column-two-third single">
                        ...
                        <span class="meta"><?php the_time(get_option('date_format')); ?>  &nbsp; // &nbsp;   <?php _e('By:', 'framework'); ?> <?php the_author_posts_link(); ?>  &nbsp;  //  &nbsp;  <?php the_category(', '); ?>  &nbsp;  //  &nbsp; <?php comments_popup_link(__( 'No Comment', 'framework' ),__( '1 comment', 'framework' ),__( '% Comments', 'framework' ),'',__( 'Comments are off', 'framework' )); ?>  
